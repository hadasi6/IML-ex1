...
from config import CITY_TEMPERATURE_DATA_PATH, AVG_DAILY_TEMP_PLOT_PATH, MONTHLY_TEMP_STD_PLOT_PATH, COUNTRY_MONTHLY_TEMP_PLOT_PATH, TEST_ERROR_PLOT_PATH, LOSS_BY_COUNTRY_PLOT_PATH
...
if __name__ == '__main__':
    # Load and preprocessing of city temperature dataset
    df = load_data(CITY_TEMPERATURE_DATA_PATH)

    # Exploring data for specific country
